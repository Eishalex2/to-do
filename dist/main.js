    ...
    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList.forEach(project => {
      if (project.current === true) {
        project.tasks.forEach(task => {
          ...
          const realTaskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate);
          const taskDate = document.createElement('div');
          if (task.dueDate === '') {
            taskDate.textContent = '';
          } else {
            taskDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(realTaskDate), 'PP');
          }
          ...
          taskPopupDiv.addEventListener('keypress', (e) => {
            if (e.key === 'Enter') {
              ...
              const newRealTaskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dueDateInput.value)
              taskDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(newRealTaskDate), 'PP');
