  ...
  taskPopupDiv.addEventListener('keypress', (e) => {
    if (e.key === 'Enter') {
      if (titleInput.value === '') {
        ...
        newTaskArea.remove();
        const newTask = (0,_createToDo__WEBPACK_IMPORTED_MODULE_1__.CreateTask)(titleInput.value, dateInput.value, descriptionInput.value, priorityInput.value);
        console.log(newTask);
...
function completedTasksUI(task) {
  ...
  if (task.dueDate === '') {
    ...
    taskDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(task.dueDate), 'PP');
  }
...
function pageLoad() {
  ...
  // tasks
  const task0 = (0,_createToDo__WEBPACK_IMPORTED_MODULE_1__.CreateTask)('Testing', '2023-06-13', 'description test', 0);
