  ...
  projectNameInput.addEventListener('keypress', (e) => {
    if (e.key === 'Enter') {
      if (projectNameInput.value === '') {
        ...
        const newProject = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].addProject(e.target.value);
...
const tasks = (() => {
  ...
  function addTask(title, projectIndex, taskIndex, dueDate, description, priority, completed) {
    ...
    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex].tasks.push(newTask);
  }
