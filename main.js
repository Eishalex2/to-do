  ...
  function showProjects() {
    ...
    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList.forEach(project => {
      ...
      projectVisible.addEventListener('click', (e) => {
        ...
        _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectArea.getAttribute('data-index')].current = true;
        showProjects();
        createProjectAdd();
        showTasks();
        createTaskAdd();
      ...
      projectNameInput.addEventListener('keypress', (e) => {
        if (e.key === 'Enter') {
          _projects__WEBPACK_IMPORTED_MODULE_0__["default"].editProject(projectNameInput.value, e.target.parentElement.parentElement.getAttribute('data-index'));
          projectVisible.classList.toggle('popup');
          projectPopupDiv.classList.toggle('popup');
      ...
      trashIcon.addEventListener('click', () => {
        if (projectArea.getAttribute('data-current') === true) {
          _projects__WEBPACK_IMPORTED_MODULE_0__["default"].deleteProject(projectArea.getAttribute('data-index'));
          _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[0].current = true;
        } else {
          _projects__WEBPACK_IMPORTED_MODULE_0__["default"].deleteProject(projectArea.getAttribute('data-index'));
        }
        projectArea.remove();
        console.log(_projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[0].current);
        showProjects();
        createProjectAdd();
        showTasks();
        createTaskAdd();
    ...
    projectNameInput.addEventListener('keypress', (e) => {
      if (e.key === 'Enter') {
        if (projectNameInput.value === '') {
          ...
          _projects__WEBPACK_IMPORTED_MODULE_0__["default"].addProject(e.target.value);
          showProjects();
          createProjectAdd();
          showTasks();
          createTaskAdd();
      ...
      if (project.current === true) {
        project.tasks.forEach(task => {
          ...
          if (task.dueDate === '') {
            ...
            taskDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(task.dueDate), 'PP');
          }
          ...
          taskPopupDiv.addEventListener('keypress', (e) => {
            if (e.key === 'Enter') {
              const currentProjectIndex = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList.findIndex(x => x.current === true);
              const currentTaskIndex = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[currentProjectIndex].tasks.findIndex(x => x.title === taskBtn.textContent);
              _tasks__WEBPACK_IMPORTED_MODULE_1__["default"].editTask(currentProjectIndex, currentTaskIndex, titleInput.value, dueDateInput.value, descriptionInput.value, priorityInput.value);
              taskBtn.textContent = titleInput.value;
              console.log(dueDateInput.value);
              taskDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(dueDateInput.value), 'PP');
          ...
          trashIcon.addEventListener('click', () => {
            const currentProjectIndex = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList.findIndex(x => x.current === true);
            const currentTaskIndex = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[currentProjectIndex].tasks.findIndex(x => x.title === taskBtn.textContent);
            _tasks__WEBPACK_IMPORTED_MODULE_1__["default"].deleteTask(currentProjectIndex, currentTaskIndex);
            showTasks();
            createTaskAdd();
          });
          ...
          circleIcon.addEventListener('click', (e) => {
            ...
            const currentProjectIndex = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList.findIndex(x => x.current === true);
            const currentTaskIndex = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[currentProjectIndex].tasks.findIndex(x => x.title === taskBtn.textContent);
            _tasks__WEBPACK_IMPORTED_MODULE_1__["default"].toggleCompleteTask(currentProjectIndex, currentTaskIndex);
            taskArea.classList.toggle('task-complete');
            _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[currentProjectIndex].tasks.forEach(task => {
    ...
    taskPopupDiv.addEventListener('keypress', (e) => {
      if (e.key === 'Enter') {
        if (titleInput.value === '') {
          ...
          const currentProjectIndex = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList.findIndex(x => x.current === true);
          const currentTaskIndex = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[currentProjectIndex].tasks.length;
          _tasks__WEBPACK_IMPORTED_MODULE_1__["default"].addTask(titleInput.value, currentProjectIndex, currentTaskIndex, dateInput.value, descriptionInput.value, priorityInput.value);
          showTasks();
          createTaskAdd();
        }
      } 
...
const tasks = (() => {
  ...
  function addTask(title, projectIndex, taskIndex, dueDate, description, priority, completed) {
    ...
    _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex].tasks.push({
      title: newTaskTitle,
  ...
  function editTask(projectIndex, taskIndex, newTitle, newDueDate, newDescription, newPriority) {
    const currentTask = _projects__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[projectIndex].tasks[taskIndex];
